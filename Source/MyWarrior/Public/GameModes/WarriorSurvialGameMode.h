...
USTRUCT(BlueprintType)
struct FWarrriorEnemyWaveSpawnerTableRow : public FTableRowBase
{
    GENERATED_BODY()
    UPROPERTY(EditAnywhere)
 ...
 */
UCLASS()
class MYWARRIOR_API AWarriorSurvialGameMode : public AWarriorBaseGameMode
{
    GENERATED_BODY()
...
private:
    ...
    FWarrriorEnemyWaveSpawnerTableRow* GetCurrentWaveSpawnerTableRow() const;
